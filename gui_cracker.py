...
def main(input_coords, confirm_coords, confirm_button_image, start_number=1, max_number=999999, log_file="numbers_tried.txt"):
    """
    ...
    while current_number <= max_number and element_exists(confirm_button_image):  # Loop while numbers remain and button exists
        # Click the input box
...
if __name__ == "__main__":
    ...
    input_coords = (500, 300)  # Replace with the (x, y) of your input field
